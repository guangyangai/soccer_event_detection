...
def count_train_val_test_labels(id_label_dict, fold_x_train, fold_x_val, fold_x_test, num_class):
    ...
    for label_num in range(num_class):  # class count
...
def print_folds_labels(id_label_dict, folds, num_class):
